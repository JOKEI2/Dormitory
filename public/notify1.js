var notify = new Vue({
    ...
    methods: {
        ...
        openformAnnoy: function () {
            ...
            // var input = document.getElementById("topic1")
            ...
            // else{
            //     if (!input.validity.patternMismatch) {
            //         document.getElementById("dp_topic").innerHTML =
            //             "กรอกเฉพาะตัวอักษร";
            //         document.getElementById("dp_topic").style.display = "block";
            //         }
            //     input.addEventListener("change", function(e) {
            //         if (input.validity.patternMismatch) {
            //             document.getElementById("dp_topic").style.display = "none";
            //         } else {
            //             document.getElementById("dp_topic").innerHTML =
            //             "กรอกเฉพาะตัวอักษร";
            //             document.getElementById("dp_topic").style.display = "block";
            ...
            //         });
            // }
            // var Bdchar = document.getElementById("buildingSelected").value;
            // var Flchar = document.getElementById("floorSelected").value;
            // var Rmchar = document.getElementById("roomSelected").value;
